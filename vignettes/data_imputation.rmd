...
Fixing $P=1$, let $A \equiv \{a_i \in \{0, 1\}: i\in N\}$ are the latent annotations and $Z \equiv \{z_i \in \{0,1,9\}: i\in N\}$ is the experimental data (some missings, 9), we measure the quality of the imputation as
