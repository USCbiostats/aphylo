...
Pr[2, 1] <- paste0("\\onslide<3->{", Pr[2, 1],"}")
Pr[2, 2] <- paste0("\\onslide<5->{", Pr[2, 2],"}")
Pr[4, 1] <- paste0("\\onslide<6->{", Pr[4, 1],"}")
Pr[4, 2] <- paste0("\\onslide<6->{", Pr[4, 2],"}")
Pr[1, 1] <- paste0("\\onslide<7->{", Pr[1, 1],"}")
Pr[1, 2] <- paste0("\\onslide<7->{", Pr[1, 2],"}")
...
\onslide<3->{& = `r Pr[3, 1]`\times `r 1-mu0` + `r Pr[3, 2]`\times `r mu0` = `r LL$Pr[3, 1]* (1-mu0) +  LL$Pr[3, 2]*mu0`}\\\\
%
...
\onslide<5->{& = `r Pr[3, 1]`\times `r mu1` + `r Pr[3, 2]`\times `r 1-mu1` = `r LL$Pr[3, 1]* mu1 +  LL$Pr[3, 2]*(1-mu1)`}\\\\
\onslide<8->{\likelihood{\psi, \mu, \Pi}{\aphyloObs} & = (1-\pi)\Prcond{\Ann_0=0}{\aphyloObs} + \pi\Prcond{\Ann_0=1}{\aphyloObs}} \\
\onslide<9->{& = (1 - `r Pi`)\times `r LL$Pr[1,1]` + `r Pi`\times `r LL$Pr[1,2]` = `r exp(LL$ll)`}
\end{aligned}
$$
