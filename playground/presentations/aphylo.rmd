...
-   Unfortunately, since annotation data is so sparse, we lack of a significant number of useful datasets on which we can test our method.

-   For the next steps, we are evaluating ways of solving the sparseness issue: either by imposing correlation structures accross functions, or jumping into another model
