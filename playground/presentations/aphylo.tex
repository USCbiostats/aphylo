...
0 &  &  \\ 
  ...
  3 &  &  \\ 
  4 & \onslide<4->{\color{red}0.1000} & \onslide<5->{\color{blue}0.9500} \\ 
  5 & \onslide<6->{\color{blue}0.9000} & \onslide<7->{\color{red}0.0500} \\ 
   \hline
\end{tabular}
\end{table}
...
\onslide<4->{\Prcond{Z_4=0}{X_4=1} & = \psi_0 & = \color{red}{0.1}} \\
\onslide<5->{\Prcond{Z_4=1}{X_4=1} & = 1 - \psi_1 &= \color{blue}{0.95}} \\ \\
\onslide<6->{\Prcond{Z_5=0}{X_5=0} & = 1 - \psi_0 & = \color{blue}{0.9}} \\
\onslide<7->{\Prcond{Z_5=1}{X_5=0} & = \psi_1 &= \color{red}{0.05}}
\end{aligned}
\]
...
\mode<beamer>{
  ...
  \only<6>{\includetikz{simple_tree_node3.tex}{.6}}
...
\begin{tabular}{rll}
 ...
 & State 0 & State 1 \\ 
  \hline
0 & \onslide<7->{0.0947} & \onslide<7->{0.0037} \\ 
  1 & \onslide<3->{0.8660} & \onslide<5->{0.0585} \\ 
  2 & 0.9000 & 0.0500 \\ 
  3 & \onslide<6->{0.1160} & \onslide<6->{0.0551} \\ 
  4 & 0.1000 & 0.9500 \\ 
  5 & 0.9000 & 0.0500 \\ 
   \hline
\end{tabular}
...
\[
\begin{aligned}
\onslide<2->{\Prcond{\Ann_1=0}{O(1)} & = \Prcond{\Ann_2 = 0}{\AnnObs_2=0}\Prcond{\Ann_2 = 0}{\Ann_1 = 0} +\\
  &\qquad \Prcond{\Ann_2 = 1}{\AnnObs_2=0}\Prcond{\Ann_2 = 1}{\Ann_1 = 0}} \\
\onslide<3->{& = 0.9000\times 0.96 + 0.0500\times 0.04 = 0.866}\\\\
%
\onslide<4->{\Prcond{\Ann_1=1}{O(1)} & = \Prcond{\Ann_2 = 0}{\AnnObs_2=0}\Prcond{\Ann_2 = 0}{\Ann_1 = 1} +\\
  &\qquad \Prcond{\Ann_2 = 1}{\AnnObs_2=0}\Prcond{\Ann_2 = 1}{\Ann_1 = 1}} \\
\onslide<5->{& = 0.9000\times 0.01 + 0.0500\times 0.99 = 0.0585}\\\\
\onslide<8->{\likelihood{\psi, \mu, \Pi}{\aphyloObs} & = (1-\pi)\Prcond{\Ann_0=0}{\aphyloObs} + \pi\Prcond{\Ann_0=1}{\aphyloObs}} \\
\onslide<9->{& = (1 - 0.5)\times 0.0947 + 0.5\times 0.0037 = 0.0492}
\end{aligned}
\]
...
{\centering \includegraphics[width=.8\linewidth]{aphylo_files/figure-beamer/plotting-ape-1} 
...
\NormalTok{tree <-}\StringTok{ }\KeywordTok{read_panther}\NormalTok{(path)}\OperatorTok{$}\NormalTok{tree}
