\documentclass[9pt,handout,ignorenonframetext,]{beamer}
...
\begin{tabular}{rll}
 ...
 & State 0 & State 1 \\ 
  \hline
0 &  &  \\ 
  1 & \onslide<3->{\color{violet}{0.8660}} & \onslide<5->{\color{purple}{0.0585}} \\ 
  2 & {\color{blue}0.9000} & {\color{red}0.0500} \\ 
  3 &  &  \\ 
  4 & 0.1000 & 0.9500 \\ 
  5 & 0.9000 & 0.0500 \\ 
   \hline
...
\onslide<3->{& = {\color{blue} {\color{blue}0.9000}}\times 0.96 + {\color{red} {\color{red}0.0500}}\times 0.04 = \color{violet}{0.866}}\\\\
%
\onslide<4->{\Prcond{\Ann_1=1}{\aphyloObs_1} & = \Prcond{\Ann_2 = 0}{\AnnObs_2=0}\mu_1 +\\
  &\qquad \Prcond{\Ann_2 = 1}{\AnnObs_2=0}(1-\mu_1)} \\
\onslide<5->{& = {\color{blue}0.9000}\times 0.01 + {\color{red}0.0500}\times 0.99 = \color{purple}{0.0585}}
\end{aligned}
\]
...
\begin{tabular}{rll}
 ...
 & State 0 & State 1 \\ 
  \hline
0 & \onslide<7->{\color{cyan}{0.0947}} & \onslide<7->{\color{blue}{0.0037}} \\ 
  1 & 0.8660 & 0.0585 \\ 
  2 & 0.9000 & 0.0500 \\ 
  3 & \onslide<5->{\color{red}{0.1160}} & \onslide<6->{0.0551} \\ 
  4 & {\color{orange}0.1000} & {\color{olive}0.9500} \\ 
  5 & {\color{brown}0.9000} & {\color{gray}0.0500} \\ 
   \hline
\end{tabular}
\end{table}
...
\onslide<3->{& = \left(%
    {\color{orange} 0.1} (1 - \mu_0) + {\color{olive} 0.95 }\times \mu_0
  \right)\times\left(%
    {\color{brown} 0.9} (1 - \mu_0) + {\color{gray} 0.05 }\times \mu_0
  \right) \\}
\onslide<4->{& = \left(%
    {\color{orange} 0.1} (1 - 0.04) + {\color{olive} 0.95}\times 0.04
  \right)\times\left(%
    {\color{brown} 0.9} (1 - 0.04) + {\color{gray} 0.05 }\times 0.04
  \right) \\}
...
\onslide<9->{& = (1 - 0.5)\times {\color{cyan} 0.0947 } + 0.5\times {\color{blue} 0.0037 } = \mbox{\normalsize 0.0492}}
\end{aligned}
\]
...
{\centering \includegraphics[width=.55\linewidth]{aphylo_files/figure-beamer/tree-pruning2-1} 
