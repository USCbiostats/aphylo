...
{\centering \includegraphics[width=.55\linewidth]{aphylo_files/figure-beamer/amcmc-gelmanplot-1} 
...
{\centering \includegraphics[width=.55\linewidth]{aphylo_files/figure-beamer/amcmc-plot-1} 
...
{\centering \includegraphics[width=.8\linewidth]{aphylo_files/figure-beamer/annotated-viz-1} 
...
{\centering \includegraphics[width=.8\linewidth]{aphylo_files/figure-beamer/likelihood-viz-1} 
...
{\centering \includegraphics[width=.35\linewidth]{aphylo_files/figure-beamer/tree-peeling2-1} 
...
{\centering \includegraphics[width=.4\linewidth]{aphylo_files/figure-beamer/plot-pred-score-1} 
