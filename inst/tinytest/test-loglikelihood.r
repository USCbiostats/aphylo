...
# test_that("Internal Probabilities", {
  ...
  # Node 1 (0,0)
  of1 <- 
    PrRaw[4:5,1]*M[1,1]*M[1,1]/4 + # (0,0), (0,0)
    PrRaw[4:5,2]*M[1,2]*M[1,1]/4 + # (0,0), (1,0)
    PrRaw[4:5,3]*M[1,1]*M[1,2]/4 + # (0,0), (0,1)
    PrRaw[4:5,4]*M[1,2]*M[1,2]/4   # (0,0), (1,1)
  
  PrRaw[2,1] <- prod(of1)
  
  # Node 2 (0,0)
  of1 <- 
    PrRaw[6:7,1]*M[1,1]*M[1,1]/4 + # (0,0), (0,0)
    PrRaw[6:7,2]*M[1,2]*M[1,1]/4 + # (0,0), (1,0)
    PrRaw[6:7,3]*M[1,1]*M[1,2]/4 + # (0,0), (0,1)
    PrRaw[6:7,4]*M[1,2]*M[1,2]/4   # (0,0), (1,1)
  
  PrRaw[3,1] <- prod(of1)
  
  # Node 1 (1,0)
  of1 <- 
    PrRaw[4:5,1]*M[2,1]*M[1,1]/4 + # (1,0), (0,0)
    PrRaw[4:5,2]*M[2,2]*M[1,1]/4 + # (1,0), (1,0)
    PrRaw[4:5,3]*M[2,1]*M[1,2]/4 + # (1,0), (0,1)
    PrRaw[4:5,4]*M[2,2]*M[1,2]/4   # (1,0), (1,1)
  
  PrRaw[2,2] <- prod(of1)
  
  # Node 2 (1,0)
  of1 <- 
    PrRaw[6:7,1]*M[2,1]*M[1,1]/4 + # (1,0), (0,0)
    PrRaw[6:7,2]*M[2,2]*M[1,1]/4 + # (1,0), (1,0)
    PrRaw[6:7,3]*M[2,1]*M[1,2]/4 + # (1,0), (0,1)
    PrRaw[6:7,4]*M[2,2]*M[1,2]/4   # (1,0), (1,1)
  
  PrRaw[3,2] <- prod(of1)
  
  # Node 1 (0,1)
  of1 <- 
    PrRaw[4:5,1]*M[1,1]*M[2,1]/4 + # (0,1), (0,0)
    PrRaw[4:5,2]*M[1,2]*M[2,1]/4 + # (0,1), (1,0)
    PrRaw[4:5,3]*M[1,1]*M[2,2]/4 + # (0,1), (0,1)
    PrRaw[4:5,4]*M[1,2]*M[2,2]/4   # (0,1), (1,1)
  
  PrRaw[2,3] <- prod(of1)
  
  # Node 2 (0,1)
  of1 <- 
    PrRaw[6:7,1]*M[1,1]*M[2,1]/4 + # (0,1), (0,0)
    PrRaw[6:7,2]*M[1,2]*M[2,1]/4 + # (0,1), (1,0)
    PrRaw[6:7,3]*M[1,1]*M[2,2]/4 + # (0,1), (0,1)
    PrRaw[6:7,4]*M[1,2]*M[2,2]/4   # (0,1), (1,1)
  
  PrRaw[3,3] <- prod(of1)
  
  # Node 1 (1,1)
  of1 <- 
    PrRaw[4:5,1]*M[2,1]*M[2,1]/4 + # (1,1), (0,0)
    PrRaw[4:5,2]*M[2,2]*M[2,1]/4 + # (1,1), (1,0)
    PrRaw[4:5,3]*M[2,1]*M[2,2]/4 + # (1,1), (0,1)
    PrRaw[4:5,4]*M[2,2]*M[2,2]/4   # (1,1), (1,1)
  
  PrRaw[2,4] <- prod(of1)
  
  # Node 2 (1,1)
  of1 <- 
    PrRaw[6:7,1]*M[2,1]*M[2,1]/4 + # (1,1), (0,0)
    PrRaw[6:7,2]*M[2,2]*M[2,1]/4 + # (1,1), (1,0)
    PrRaw[6:7,3]*M[2,1]*M[2,2]/4 + # (1,1), (0,1)
    PrRaw[6:7,4]*M[2,2]*M[2,2]/4   # (1,1), (1,1)
  
  PrRaw[3,4] <- prod(of1)
  
  # Node 0 (0,0)
  of1 <- 
    PrRaw[2:3,1]*M[1,1]*M[1,1]/4 + # (0,0), (0,0)
    PrRaw[2:3,2]*M[1,2]*M[1,1]/4 + # (0,0), (1,0)
    PrRaw[2:3,3]*M[1,1]*M[1,2]/4 + # (0,0), (0,1)
    PrRaw[2:3,4]*M[1,2]*M[1,2]/4   # (0,0), (1,1)
  
  PrRaw[1,1] <- prod(of1)
  
  # Node 0 (1,0)
  of1 <- 
    PrRaw[2:3,1]*M[2,1]*M[1,1]/4 + # (1,0), (0,0)
    PrRaw[2:3,2]*M[2,2]*M[1,1]/4 + # (1,0), (1,0)
    PrRaw[2:3,3]*M[2,1]*M[1,2]/4 + # (1,0), (0,1)
    PrRaw[2:3,4]*M[2,2]*M[1,2]/4   # (1,0), (1,1)
  
  PrRaw[1,2] <- prod(of1)
  
  # Node 0 (0,1)
  of1 <- 
    PrRaw[2:3,1]*M[1,1]*M[2,1]/4 + # (0,1), (0,0)
    PrRaw[2:3,2]*M[1,2]*M[2,1]/4 + # (0,1), (1,0)
    PrRaw[2:3,3]*M[1,1]*M[2,2]/4 + # (0,1), (0,1)
    PrRaw[2:3,4]*M[1,2]*M[2,2]/4   # (0,1), (1,1)
  
  PrRaw[1,3] <- prod(of1)
  
  # Node 0 (1,1)
  of1 <- 
    PrRaw[2:3,1]*M[2,1]*M[2,1]/4 + # (1,1), (0,0)
    PrRaw[2:3,2]*M[2,2]*M[2,1]/4 + # (1,1), (1,0)
    PrRaw[2:3,3]*M[2,1]*M[2,2]/4 + # (1,1), (0,1)
    PrRaw[2:3,4]*M[2,2]*M[2,2]/4   # (1,1), (1,1)
